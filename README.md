...
Please note: This is an ongoing project and some of functionalities (titles) that you can see in the segments are functionalities that I would like to work on in the future.  
<br/>
